...
# def mask_edges_bns_link_prediction(G, adj, val_percent, test_percent, split_seed, save_path):
#     """
...
#     val_pos_edges, test_pos_edges = train_test_split(val_test_pos_edges, 
#                                                      test_size=test_size, 
#                                                      train_size=val_size, 
...
#     '''save'''
#     kth_fold_cross_validation_split_save(train_pos_edges, val_pos_edges, val_neg_edges, test_pos_edges, test_neg_edges, save_path)
...
#     G_train, _ = load_graph(os.path.join(save_path, 'train_edges.txt'))
...
#     # print(test_pos_edges, test_neg_edges)
#     # pdb.set_trace()
        
#     return 


# def mask_edges_bidirectionality_link_prediction(G, adj, split_seed, save_path):
#     """
...
#     val_neg_edges, test_neg_edges  = train_test_split(val_test_neg_edges, 
#                                                       test_size=test_size, 
#                                                       train_size=val_size, 
#                                                       random_state=split_seed, 
#                                                       shuffle=True, stratify=None)
...
#     # print("val_pos_edges: ", val_pos_edges)
#     # print("val_neg_edges: ", val_neg_edges)
#     # print("test_pos_edges: ", test_pos_edges)
#     # print("test_neg_edges: ", test_neg_edges)
...
#                              '{}_fold_cross_validation'.format(args.total_k),
#                              'fold_{}'.format(args.k))
    
#     mask_edges_general_link_prediction(G, adj, args.val_percent, args.test_percent, args.random_seed, save_path)
    
    
#     # task 2
#     save_path = os.path.join(args.output_path, 
#                              args.dataset, 
#                              'BNS_Directed_Link_Prediction', 
#                              '{}_fold_cross_validation'.format(args.total_k),
#                              'fold_{}'.format(args.k))
    
#     mask_edges_bns_link_prediction(G, adj, args.val_percent, args.test_percent, args.random_seed, save_path)


#     # task 3
#     save_path = os.path.join(args.output_path, 
#                              args.dataset, 
#                              'Bidirectionality_Prediction', 
#                              '{}_fold_cross_validation'.format(args.total_k),
#                              'fold_{}'.format(args.k))
    
#     mask_edges_bidirectionality_link_prediction(G, adj, args.random_seed, save_path)
